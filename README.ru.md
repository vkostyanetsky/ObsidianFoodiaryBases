...
Эта база автоматически считает КБЖУ как по каждому приёму пищи и по дням в целом.
...
> [!tip]
> В [примере](vault) такие карточки находятся в папке [Products](vault/Products), но вообще они могут лежать где угодно.
...
> [!tip]
> Я использую плагин [Meld Calc](https://github.com/meld-cp/obsidian-calc) для быстрого расчета веса съеденного, если нужно, например, вычесть из веса блюда вес тары.
